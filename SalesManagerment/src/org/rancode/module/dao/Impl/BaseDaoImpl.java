...
public class BaseDaoImpl implements BaseDao {
	...
	private static Logger logger = Logger.getLogger(BaseDaoImpl.class);//日志

	private Connection conn;//接口，与特定数据库连接
	private PreparedStatement pst;//预编译对象
	private ResultSet rs;//结果集合
