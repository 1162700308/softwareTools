...
public class ModifyStockJFrame extends JFrame implements MouseListener {
	...
	public ModifyStockJFrame(GoodsManagerJPanel parentPanel, JTable table, int selectedRow) {
		this.table = table;
